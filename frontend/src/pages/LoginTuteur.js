  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        const role = response.data.user?.role || 'tuteur';
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        <h1>📚 PERSEE</h1>
        <h2>👨‍🏫 Connexion</h2>
        <p className="auth-subtitle">Tuteur • Admin</p>
        ...
        <div className="auth-links">
          <p>
            Pas encore de compte ? <Link to="/register-tuteur">S'inscrire</Link>
          </p>
          <p>
